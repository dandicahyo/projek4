...
<body>
                            ...
                            <ul class="mobile-menu-nav">
                                ...
                                <li><a data-toggle="collapse" data-target="#demoevent" href="#">Data</a>
                                    <ul id="demoevent" class="collapse dropdown-header-top">
                                        ...
                                        <li><a href="view-email.html">Tambah Penjual</a></li>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li><a data-toggle="tab" href="#Charts"><i class="notika-icon notika-bar-chart"></i> Data</a>
                        </li>

                        <li ><a data-toggle="tab" href="#Forms"><i class="notika-icon notika-form"></i> Transaksi</a>
                        </li>
                        <li class="active"><a data-toggle="tab" href="#Page"><i class="notika-icon notika-support"></i> Profile</a>
                        </li>
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="breadcomb-wp">
									...
									<div class="breadcomb-ctn">
										<h2>Edit Profile</h2>
										<p>Welcome to E-Trash <span class="bread-ntd">Admin</span></p>
									</div>
								</div>
							</div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-example-wrap">
                        ...
                        <?php
                        $p= $_SESSION['uid'];
                        $query = "SELECT * FROM user WHERE uid='".$p."'";
  ...
  ?>
                        ...
                        <form method="post" action="proseseditprofile.php?id=<?php echo $p; ?>" enctype="multipart/form-data">
                        <div class="form-example-int">
                            <div class="form-group">
                                <label>Nama</label>
                                <div class="nk-int-st">
                                    <input type="text" class="form-control input-sm" name="nama" value="<?php echo $data['name']; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="form-example-int mg-t-15">
                            <div class="form-group">
                                <label>Status</label>
                                <div class="nk-int-st">
                                    <input type="text" class="form-control input-sm" name="role" value="<?php echo $data['role']; ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-example-int mg-t-15">
                            <div class="form-group">
                                ...
                                <div class="nk-int-st">
                                <input type="text" class="form-control input-sm" name="password" value="<?php echo $data['password']; ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-example-int mg-t-15">
                            <div class="form-group">
                                <label>Email</label>
                                <div class="nk-int-st">
                                    <input type="text" class="form-control input-sm" name="email" value="<?php echo $data['email']; ?>">
                                </div>
                            </div>
                        </div>
