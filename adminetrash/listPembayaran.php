...
<?php include('koneksi.php'); ?>
    ...
    <div class="data-table-area">
      ...
      <?php $d = $_SESSION['uid'];
        $query = mysqli_query($host, "SELECT *,s.id_Setor as coba FROM setor as s inner join banksampah as b on s.id_bank=b.id_banksampah where b.uid = '$d' AND s.pembayaran = 1"); ?>
                              ...
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    <?php
                                    $hmm = $data['coba'];
                                    $queryH = mysqli_query($host, "SELECT * from Pembayaran where id_setor = $hmm;");
                                    $dataku = mysqli_fetch_array($queryH);
                                    ...
                                    <form action="#">
                                      <div class="form-group">
                                        ...
                                        <input type="text" name="berat" class="form-control" value="<?= $dataku['berat'] ?> KG" disabled id="nama" required>
                                       </div>
                                       <div class="form-group">
                                         <label for="noTelp" class="col-form-label">Hargaa:</label>
                                         <input type="text" disabled value="<?= "Rp. " . number_format($dataku['harga'], 0, '', ','); ?>" class="form-control" id="noTelp" required>
                                       </div>
