...
<?php
                        ...
                        <form method="post" action="proseseditbarang.php?id=<?php echo $id; ?>" enctype="multipart/form-data">
                        <div class="form-example-int">
                            <div class="form-group">
                                <label>Nama</label>
                                <div class="nk-int-st">
                                    <input type="text" class="form-control input-sm" name="nama"  value="<?php echo $data['nama']; ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-example-int mg-t-15">
                            <div class="form-group">
                                ...
                                <div class="nk-int-st">
                                    <input type="text" class="form-control input-sm" name="idbank" value="<?php echo $data['id_banksampah']; ?>">
                                </div>
                            </div>
                        </div>
