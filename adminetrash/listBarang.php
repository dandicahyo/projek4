...
<?php include('koneksi.php'); ?>
    ...
    <div class="data-table-area">
      ...
      <?php 
        echo $d;
        $query = mysqli_query($host, "SELECT * FROM barang as b inner join banksampah as a on b.id_banksampah = a.id_banksampah where uid = '$d'"); ?>
        ...
        while ($data = mysqli_fetch_array($query)) {
            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="editbarang.php?id=<?= $data['id']?> " type="button" class="btn btn-primary"> Edit Barang</a></td>

                                        <td><a href="proseshapus.php?id=<?= $data['id'] ?> " type="button" class="btn btn-primary">Hapus Barang</a></td>
