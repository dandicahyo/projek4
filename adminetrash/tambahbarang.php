            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li class="active"><a data-toggle="tab" href="#Interface"><i class="notika-icon notika-edit"></i> Barang</a>
                        </li>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-example-wrap">
                        ...
                        <form method="post" action="prosestambahbarang.php" enctype="multipart/form-data">
                        <div class="form-example-int">
                            <div class="form-group">
                                <label>Nama</label>
                                <div class="nk-int-st">
                                    <input type="text" class="form-control input-sm" name="nama" placeholder="Enter Nama Barang">
                                </div>
                            </div>
                        </div>
                        <div class="form-example-int mg-t-15">
                            <div class="form-group">
                                <label>Harga</label>
                                <div class="nk-int-st">
                                    <input type="text" class="form-control input-sm" name="harga" placeholder="Enter Harga Barang">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-example-int mg-t-15">
                            <div class="form-group">
                                <label>Foto</label>
                                <div class="nk-int-st">
                                    <input class="form-control-file " name="gambar" type="file" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-example-int mg-t-15">
                            <div class="form-group">
                                ...
                                <div class="nk-int-st">
                                    <input type="text" class="form-control input-sm" name="idbank" placeholder="Enter Id Bank Sampah">
                                </div>
                            </div>
                        </div>
