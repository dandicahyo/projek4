...
<body>
  ...
  ?>
                        ...
                        <form method="post" action="proseseditbank.php" enctype="multipart/form-data">
                        <div class="form-example-int">
                            <div class="form-group">
                                <label>Nama Bank Sampah</label>
                                <div class="nk-int-st">
                                    <input type="text" class="form-control input-sm" name="nama" value="<?php echo $data['nama_bank']; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="form-example-int mg-t-15">
                            <div class="form-group">
                                <label>Alamat</label>
                                <div class="nk-int-st">
                                    <input type="text" class="form-control input-sm" name="alamat" value="<?php echo $data['alamat']; ?>">
                                </div>
                            </div>
                        </div>
