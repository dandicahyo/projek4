...
<?php include('koneksi.php'); ?>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li class="active"><a data-toggle="tab" href="#Forms"><i class="notika-icon notika-form"></i> Transaksi</a>
                        </li>
    ...
    <div class="data-table-area">
      ...
      <?php 
        echo $d;
        $query = mysqli_query($host, "SELECT *,a.alamat as hmm FROM transaksi as a inner join barang as b on a.id_Barang=b.id inner join banksampah as c on b.id_banksampah = c.id_banksampah  where c.uid = '$d'"); ?>
