            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li class="active"><a data-toggle="tab" href="#Page"><i class="notika-icon notika-support"></i> Transaksi</a>
                        </li>
                    ...
                    <div class="data-table-list">
                        ...
                        <div class="table-responsive">
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                a.nomer_Telp,a.jumlah,a.Total,a.alamat,a.kecamatan,a.kota,b.nama as nm,z.nama_bank as nb FROM transaksi as a INNER JOIN BARANG as b on id=id_Barang inner join banksampah as z on b.id_banksampah=z.id_banksampah");
