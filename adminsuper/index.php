                            ...
                            <ul class="mobile-menu-nav">
                                ...
                                <li><a data-toggle="collapse" data-target="#demoevent" href="#">Data</a>
                                    <ul id="demoevent" class="collapse dropdown-header-top">
                                        <li><a href="datapenjual.php">Data Penjual</a></li>
                                        <li><a href="tambahpenjual.php">Tambah Penjual</a></li>
                                    </ul>
                                </li>
                                <li><a data-toggle="collapse" data-target="#democrou" href="#">Barang</a>
                                    <ul id="democrou" class="collapse dropdown-header-top">
                                        ...
                                        <li><a href="listBarang.html">list Barang</a></li>
                                    </ul>
                                </li>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li><a data-toggle="tab" href="#Interface"><i class="notika-icon notika-edit"></i> Bank Sampah</a>
                        </li>
                        <li><a data-toggle="tab" href="#Charts"><i class="notika-icon notika-bar-chart"></i> Accepting</a>
                        </li>

                        </li>
                        <li><a data-toggle="tab" href="#Page"><i class="notika-icon notika-support"></i> Transaksi</a>
                        </li>
                        <li><a data-toggle="tab" href="#hmm"><i class="notika-icon notika-support"></i> Saran</a>
                        </li>
                        <li><a data-toggle="tab" href="#setor"><i class="notika-icon notika-support"></i> Penyetor</a>
                        </li>
                    ...
                    <div class="tab-content custom-menu-content">
                        ...
                        <div id="Interface" class="tab-pane notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                <li><a href="databank.php">List Bank Sampah</a></li>
                            </ul>
                        </div>
                        <div id="Charts" class="tab-pane notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                            <li><a href="active.php">Accepting Bank Sampah</a></li>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div id="Page" class="tab-pane notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                <li><a href="listTransaksi.php"> Data Transaksi</a></li>
                                </li>
                            </ul>
</div>
                            <div id="hmm" class="tab-pane notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                <li><a href="flot-charts.html"> List Saran</a></li>
                                </li>
                            </ul>
                        ...
                        <div id="setor" class="tab-pane notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                <li><a href="listPenyetor.php"> List Penyetor</a></li>
                                </li>
                            </ul>
