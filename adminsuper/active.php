            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li class="active"><a data-toggle="tab" href="#Charts"><i class="notika-icon notika-bar-chart"></i> Accepting</a>
                        </li>
                    ...
                    <div class="data-table-list">
                        ...
                        <div class="table-responsive">
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tbody>
                                <?php
                                $query = mysqli_query($host, "Select * from user where role = 'BANK_SAMPAH' AND status = 0");
                                if (mysqli_num_rows($query) > 0) {
                                    while ($data = mysqli_fetch_array($query)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $data['email']; ?></td>
                                            <td><?= $data['role']; ?></td>
                                            <td><a href="prosesActive.php?id=<?= $data['uid']; ?>" class="btn btn-success">active</a></td>
                                        </tr>
