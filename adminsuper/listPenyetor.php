            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li class="active"><a data-toggle="tab" href="#setor"><i class="notika-icon notika-support"></i> Penyetor</a>
                        </li>
                    ...
                    <div class="tab-content custom-menu-content">
                        ...
                        <div id="setor" class="tab-pane  in active notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                    ...
                    <div class="data-table-list">
                        ...
                        <div class="table-responsive">
                            <table id="data-table-basic" class="table table-striped">
                             ...
                             $query = mysqli_query($host, "SELECT *,b.nama_bank as nb,s.alamat as al  FROM setor as s inner join banksampah as b on s.id_bank=b.id_banksampah"); ?>
